...
CodeNexus depends on two components: (1) **sandboxed language runtimes** for code execution during reward computation, and (2) the standard **SFT / RL training** stacks.
